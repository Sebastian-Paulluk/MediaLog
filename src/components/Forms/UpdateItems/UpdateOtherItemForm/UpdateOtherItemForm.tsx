...
export const UpdateOtherItemForm: React.FC<UpdateOtherItemFormTypes> = ({
	item,
	onClose,
	onSubmit,
}) => {
	...
	const hasDataItemChanged = (
		currentData: Partial<OthersItemTypes>,
