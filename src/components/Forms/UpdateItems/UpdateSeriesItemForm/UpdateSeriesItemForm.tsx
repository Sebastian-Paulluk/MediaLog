...
export const UpdateSeriesItemForm: React.FC<UpdateSeriesItemFormTypes> = ({
	item,
	onClose,
	onSubmit,
}) => {
	...
	const hasDataItemChanged = (
		currentData: Partial<SeriesItemTypes>,
