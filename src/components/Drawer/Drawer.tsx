...
export const Drawer: React.FC<DrawerTypes> =({open, hideDrawer})=>{
    ...
    const [localCategories , setLocalCategories] = useState<CategoryTypes[]>(categories);
    const [openCategory, setOpenCategory] = useState<CategoryTypes | null>(null);
        ...
        <div className={`drawer ${visibility ? '': 'hidden'}`}>
            ...
            <div className='drawer__menu'>
                <div className='drawer__menu__header'>
                    ...
                    <button className='drawer__menu__header__close-button' onClick={handleCloseDrawer}>
                        <img className='close-button-img' src={closeImg} alt='close' />
                    </button>
                </div>
